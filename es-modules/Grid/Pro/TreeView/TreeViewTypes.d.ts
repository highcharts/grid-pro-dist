 ...
 */
export type TreeInputOptions = (TreeInputParentIdOptions | TreeInputPathOptions);
/**
 ...
 */
export type TreeInputPathSeparator = (string | RegExp | TreeInputPathSeparatorCallback);
/**
...
export interface TreeInputAdapter {
    buildIndexFromColumns(columns: ColumnCollection, idColumn: string, input: TreeInputOptions): TreeIndexBuildResult;
}
